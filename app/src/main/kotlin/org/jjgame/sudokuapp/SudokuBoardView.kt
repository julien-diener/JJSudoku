...
class SudokuBoardView @JvmOverloads constructor(
    ...
    private fun applyThemeColors() {
        ...
        paintThinLine.strokeWidth = ThemeResolver.resolveDimension(context, R.attr.boardGridThinWidth, 1f)
        paintThickLine.color = ThemeResolver.resolveColor(context, R.attr.colorBoardGridThick)
        paintThickLine.strokeWidth = ThemeResolver.resolveDimension(context, R.attr.boardGridThickWidth, 4f)
