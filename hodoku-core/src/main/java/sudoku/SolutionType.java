...
public enum SolutionType {
	...
	ALS_XY_CHAIN("Almost Locked Set Chain", "0903", "ach"),
	...
	FORCING_NET_VERITY("Forcing Net Verity", "1304",
			"fnv"),
	...
	public boolean isSingle() {
		if (this == HIDDEN_SINGLE || this == NAKED_SINGLE || this == FULL_HOUSE) {
			return true;
		}
		return false;
	}
...
//        }
	...
	public boolean isKrakenFish() {
		if (this == KRAKEN_FISH || this == KRAKEN_FISH_TYPE_1 || this == KRAKEN_FISH_TYPE_2) {
			return true;
		}
		return false;
	}
